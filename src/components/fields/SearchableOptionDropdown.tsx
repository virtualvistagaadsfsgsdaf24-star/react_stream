...
const Spinner = () => (
  <svg
    viewBox="0 0 24 24"
    className="w-[15px] h-[15.62px] animate-spin text-current"
    aria-hidden="true"
    focusable="false"
  >
    <circle
    ...
    <div className="relative" ref={containerRef}>
      <button
        ...
        className={cn(
          ...
          !hasSelection && !buttonClassName?.includes("text-")
            ? "text-neutral-400"
            : "",
          hasSelection && !buttonClassName?.includes("text-")
            ? "text-neutral-700"
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="text-xs font-semibold uppercase text-neutral-400">
                  <th className="px-3 py-1 text-left whitespace-nowrap">
                    {codeHeader}
                  </th>
              ...
              <tbody>
                {filteredOptions.length === 0 ? (
                  <tr>
                    <td
                      colSpan={2}
                      className="px-2 py-3 text-center text-sm text-neutral-400"
                    >
                      {emptyMessage}
                    </td>
                  </tr>
                  ...
                  filteredOptions.map((option) => {
                    ...
                    return (
                      ...
                      >
                        <td className="px-3 py-2 whitespace-nowrap font-semibold text-neutral-500">
                          {option.code}
                        </td>
